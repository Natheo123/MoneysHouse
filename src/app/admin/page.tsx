...
import { AdminTipsSection } from "@/components/admin/AdminTipsSection";
...
export default function AdminPage() {
  ...
  return (
    <PageShell maxWidth="3xl">
        ...
        <GsapScrollReveal>
          <div className="mb-12">
            <AdminNotificationsSection userEmail={user.email} />
          </div>
        </GsapScrollReveal>

        <GsapScrollReveal>
          <div className="mb-12">
            <AdminTipsSection userEmail={user.email} />
          </div>
        </GsapScrollReveal>

        <div className="mb-12">
          <AdminReviewsSection userEmail={user.email} />
        </div>
